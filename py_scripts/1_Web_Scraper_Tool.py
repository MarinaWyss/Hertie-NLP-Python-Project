...
print('number of entries in old data: {}'.format(num_breitbart_old))
print('total number of entries in new data: {}'.format(num_breitbart_now))
...
print('number of entries in old data: {}'.format(num_fox_old))
print('total number of entries in new data: {}'.format(num_fox_now))
...
print('number of entries in old data: {}'.format(num_wt_old))
print('total number of entries in new data: {}'.format(num_wt_now))
...
print('number of entries in old data: {}'.format(num_ap_old))
print('total number of entries in new data: {}'.format(num_ap_now))
...
print('number of entries in old data: {}'.format(num_nbc_old))
print('total number of entries in new data: {}'.format(num_nbc_now))
...
print('number of entries in old data: {}'.format(num_nyt_old))
print('total number of entries in new data: {}'.format(num_nyt_now))
...
print('number of entries in old data: {}'.format(num_politico_old))
print('total number of entries in new data: {}'.format(num_politico_now))
...
print('number of entries in old data: {}'.format(num_buzz_old))
print('total number of entries in new data: {}'.format(num_buzz_now))
